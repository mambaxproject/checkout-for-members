...
class SendLinkUpdateOfferCustomerRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($hasRecentRequestLinkUpdate) {
                $validator->errors()->add('order', 'Você já solicitou o link de atualização do produto de assinatura nas últimas 24 horas.');
            }
        });
    }
