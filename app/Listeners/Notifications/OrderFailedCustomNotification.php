...
class OrderFailedCustomNotification implements ShouldQueue
{
    ...
    public function handle(OrderFailed $event): void
    {
        ...
        try {
            ...
            $this->eventTypeId = CustomNotificationEventEnum::CARDPAYMENTERROR->value;
            $this->generalProcess();
        } catch (\Throwable $th) {
            Log::channel('notification')->error(
                ...
                [
                    'error' => $th->getMessage(),
                    'function' => 'OrderFailedCustomNotification.handle',
