                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                ...
                                @foreach(App\Models\CouponDiscount::TYPE_RADIO as $key => $item)
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\CouponDiscount::STATUS_RADIO as $key => $item)
                                    <option value="{{ $item }}">{{ $item }}</option>
                                @endforeach
                            </select>
                        </td>
                            ...
                            <td>
                                @can('discount_coupon_show')
                                    <a class="btn btn-xs btn-primary"
                                       href="{{ route('admin.discount-coupons.show', $discountCoupon->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('discount_coupon_edit')
                                    <a class="btn btn-xs btn-info"
                                       href="{{ route('admin.discount-coupons.edit', $discountCoupon->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('discount_coupon_delete')
                                    <form action="{{ route('admin.discount-coupons.destroy', $discountCoupon->id) }}"
