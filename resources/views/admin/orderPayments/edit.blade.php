    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.order-payments.update", [$orderPayment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_method') ? 'is-invalid' : '' }}" type="text" name="payment_method" id="payment_method" value="{{ old('payment_method', $orderPayment->payment_method) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="noScrollInput form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', $orderPayment->amount) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_status') ? 'is-invalid' : '' }}" type="text" name="payment_status" id="payment_status" value="{{ old('payment_status', $orderPayment->payment_status) }}" required>
