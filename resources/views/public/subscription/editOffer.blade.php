...
<html lang="pt-BR">
    ...
    <body class="bg-gray-50 min-h-screen py-8">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="bg-white rounded-lg shadow-sm border mb-6">
                <div class="p-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Dados do plano</h2>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <div class="text-sm text-gray-600 mb-1">PLANO ATUAL</div>
                            <div class="text-gray-800 font-medium mb-5">
                                {{ $order->item->product->name }}
                            </div>

                            <div class="text-sm text-gray-600 mb-1">VALOR ATUAL</div>
                            <div class="text-gray-800 font-medium">
                                {{ $order->item->product->brazilianPrice }}
                            </div>
                        </div>

                        <div>
                            <div class="text-sm text-gray-600 mb-1">NOVO PLANO</div>
                            <div class="text-gray-800 font-medium mb-4">
                                {{ $product->name }}
                            </div>

                            <div class="text-sm text-gray-600 mb-1">NOVO VALOR</div>
                            <div class="text-gray-800 font-medium">
                                {{ $product->brazilianPrice }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border mb-6">
                <form method="POST"
                      action="{{ route('public.subscription.updateOffer', [$order->id]) }}"
                      onsubmit="return confirm('Tem certeza?')"
                >
                    @csrf

                    <input type="hidden" name="offer_id" value="{{ $product->id }}">
