...
@section('content')
    <div class="relative space-y-6 md:space-y-8 lg:space-y-10">
        ...
        <h1>Links de coprodutor do produto <b>{{ $product->name }}</b></h1>
                            ...
                            <div class="overflow-x-scroll md:overflow-visible">
                                <table class="table-lg table w-full">
                                    ...
                                    @forelse ($activeOffers as $offer)
                                        @php($linkCoproducer = url($offer->url))
                                        <tr>
                                            <td>{{ $offer->name }}</td>
                                            ...
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span
                                                        ...
                                                        data-clipboard-text="{{ $linkCoproducer }}"
                                                    >
                                                        {{ $linkCoproducer }}
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center">Nenhuma oferta ativa</td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                </table>
