...
function Earnings() {
    ...
    colors: ["rgba(" + myVarVal + ", 0.3)", "rgba(" + myVarVal + ", 0.3)", "rgba(" + myVarVal + ", 0.3)", "rgba(" + myVarVal + ", 0.3)", "rgb(" + myVarVal + ")", "rgba(" + myVarVal + ", 0.3)", "rgb(228,231,237)", "rgb(228,231,237)", "rgb(228,231,237)", "rgb(228,231,237)", "rgb(228,231,237)", "rgb(228,231,237)"],
    })
}