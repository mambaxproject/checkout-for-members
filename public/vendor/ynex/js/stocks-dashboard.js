...
document.getElementById('total-investments').innerHTML = '';
var stocks2 = new ApexCharts(document.querySelector("#total-investments"), stocks2);
stocks2.render();
/* No Of Investments Chart */
...
document.getElementById('returns-rate').innerHTML = '';
...
document.getElementById('stocks-marketcap').innerHTML = '';
var chart = new ApexCharts(document.querySelector("#stocks-marketcap"), options);
chart.render();
